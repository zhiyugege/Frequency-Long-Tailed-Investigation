...
def get_loaders(dir_, batch_size, DATASET='CIFAR10', _type='cifar10'):
    ...
    num_workers = 8
    if _type == 'cifar10B' or _type== 'cifar100B':
        f_test = True
    else:
        f_test = False

    if _type=='cifar100' or _type=='cifar100B':
        DATASET = 'CIFAR100'
    ...
    if DATASET == 'CIFAR10':
        ...
        test_dataset = datasets.CIFAR10(
            dir_, train=False, transform=test_transform, download=True,f_test=f_test)
