...
def get_loaders(dir_, batch_size, DATASET='CIFAR10', f_test=True):
    ...
    if f_test:
        train_dataset.data = get_BaSS_dataset(train_dataset.data.copy())
        test_dataset.data = get_BaSS_dataset(test_dataset.data.copy())
